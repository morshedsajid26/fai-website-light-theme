...
const Button = ({ buttonText, icon, buttonClass }) => {
  return (
    <button className="relative inline-flex overflow-hidden rounded-2xl p-[3px] transition-transform hover:scale-105 active:scale-95 group">
      {/* Rotating Background */}
